...
void Endstops::update() {
  ...
  #define X_MIN_TEST() TERN1(DUAL_X_CARRIAGE, TERN0(X_HOME_TO_MIN, idex_get_carriage(stepper.last_moved_extruder) == 0) || TERN0(X2_HOME_TO_MIN, idex_get_carriage(stepper.last_moved_extruder) != 0))
  #define X_MAX_TEST() TERN1(DUAL_X_CARRIAGE, TERN0(X_HOME_TO_MAX, idex_get_carriage(stepper.last_moved_extruder) == 0) || TERN0(X2_HOME_TO_MAX, idex_get_carriage(stepper.last_moved_extruder) != 0))
