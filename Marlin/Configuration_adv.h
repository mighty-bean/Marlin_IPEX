...
//
  ...
  //#define CHAMBER_FAN               // Enable a fan on the chamber
    ...
    #define CHAMBER_FAN_INDEX   5   // Index of a fan to repurpose as the chamber fan. (Default: first unused fan)
 ...
 */
#define MILLISECONDS_PREHEAT_TIME 10000 // 10 seconds
...
#define DUAL_X_CARRIAGE
  ...
  #define X2_MIN_POS   20        // A min coordinate so the X2 carriage can't hit the parked X1 carriage
  ...
  #define INACTIVE_EXTRUDER_BASETEMP 175
  #if INACTIVE_EXTRUDER_BASETEMP > 0
  #define LIMIT_INACTIVE_EXTRUDER_TEMP
  #define INACTIVE_EXTRUDER_TEMPERATURE_OFFSET 25 // reduce unused nozzle temps by at least this much
  #endif
