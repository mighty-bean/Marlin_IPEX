...
#define HOTEND_OFFSET_X { 0.0, 18.00, 343.50, 361.50 } // (mm) relative X-offset for each nozzle
#define HOTEND_OFFSET_Y { 0.0, 0.00, 0.00, 0.00 }  // (mm) relative Y-offset for each nozzle
